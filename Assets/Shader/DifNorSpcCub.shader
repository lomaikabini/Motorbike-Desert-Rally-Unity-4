...
Shader "Shader/DifNorSpcCub"{
Properties {
	_Color ("Main Color", Color) = (1,1,1,1)
	_SpecColor ("Specular Color", Color) = (1, 1, 1, 1)
	_Shininess ("Shininess", Range (0.01, 3)) = 0.1
	_Gloss("Gloss", Range (0.00, 2)) = .5
	_Reflection("Reflection", Range (0.00, 5.0)) = 2.0
	//_FrezPow("Fresnel Reflection",Range(0,2)) = .25
	//_FrezFalloff("Fresnal/EdgeAlpha Falloff",Range(0,10)) = 4
	//_EdgeAlpha("Edge Alpha",Range(0,5)) = 2.0
	_Metalics("Metalics",Range(0,5)) = 2.0
